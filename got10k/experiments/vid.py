...
class ExperimentVID(object):
    ...
    def __init__(self, root_dir,
        ...
        super(ExperimentVID, self).__init__()

        self.dataset = VIDVOT(root_dir, anno_type='default', return_meta=False, list_file=list_file)
        self.read_image = read_image
        self.result_dir = os.path.join(result_dir, 'VID_val')
        self.report_dir = os.path.join(report_dir, 'VID_val')
    ...
    def run(self, tracker, visualize=False):
        ...
        self.run_exp(tracker, visualize)

    def run_exp(self, tracker, visualize=False):
...
#                tag_num = len(self.tags)
                masks[seq_name] = np.zeros((1, frame_num), bool)
# =============================================================================
...
# =============================================================================
            ...
            accuracy = np.nanmean(ious)
            robustness = np.nansum(failures)
        ...
        return performance, ious, failures
