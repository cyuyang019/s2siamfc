...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default="VOT2016", type=str, help='dataset name')
    parser.add_argument('--result_dir', default="./results/VOT2016", type=str, help='tracker result root')
#    parser.add_argument('--result_dir', default="./results/Comparison", type=str, help='tracker result root')
    parser.add_argument('--tracker_prefix', default="T", type=str, help='tracker prefix')
