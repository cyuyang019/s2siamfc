...
from .losses import Weighted_BalancedLoss, BalancedLoss, Weighted_BalancedLoss_FT, RankLoss
...
class TrackerSiamFC(Tracker):
    ...
    def __init__(self, net_path=None, name='SiamFC', loss_setting=[0, 1.5, 0], ft_ep=5,**kwargs):
...
# =============================================================================
    ...
    def init(self, img, box, ft=True):
        ...
        #online fine-tuning using first frame
            ...
            self.net.train()
            freeze_bn = True
            ft_epochs = self.ft_ep
#            self.criterion = Weighted_BalancedLoss_FT(pos_thres=0, alpha=1.5, margin=0)
            # setup dataset
...
#             dataset = Single_image_ft(
#                 img=img,
#                 transforms=transforms, box=box, supervised='supervised')
# =============================================================================
...
# =============================================================================
#             self.ft_optimizer = optim.Adam(
#                 self.net.backbone.conv5.parameters(),
#                 lr=self.cfg.ultimate_lr,            #1e-5
#                 weight_decay=self.cfg.weight_decay)
# =============================================================================
