...
#    tracker = TrackerSiamFC(net_path=net_path, name='eccv_best_linear')   
    ...
    net_path = './checkpoints/S2SiamFC/siamfc_alexnet_e50.pth'
...
# =============================================================================
    ...
    root_dir = '/Users/chenyuyang/Desktop/VOT2016'
    VOT16_exp = ExperimentVOT(root_dir, version=2016, experiments='finetune', read_image=False) # 18859 images
    VOT16_exp.run(tracker, visualize=False)

    #VOT16_exp.show([tracker.name])
    VOT16_exp.show(["result_after_finetune"])
#       p, ious, fail = VOT16_exp.report([tracker.name])
    '''
    root_dir = '/Users/chenyuyang/Desktop/VOT2018'
